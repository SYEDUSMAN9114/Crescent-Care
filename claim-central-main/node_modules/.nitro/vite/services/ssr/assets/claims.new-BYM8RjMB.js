import { n as money, r as AppShell } from "./claims-data-Cm40imDG.js";
import { useEffect, useMemo, useRef, useState } from "react";
import { Link } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { ArrowLeft, Clock, Columns2, FileText, Minus, Paperclip, PictureInPicture2, Plus, Save, Search, Trash2, UploadCloud, X } from "lucide-react";
//#region src/components/DocumentsPanel.tsx
...
function Viewer({ doc }) {
	if (!doc) return /* @__PURE__ */ jsx("div", {
	...
	if (doc.type.startsWith("image/")) return /* @__PURE__ */ jsx("div", {
	...
	if (doc.type === "application/pdf") return /* @__PURE__ */ jsx("iframe", {
		src: doc.url,
		title: doc.name,
	...
	return /* @__PURE__ */ jsx("div", {
		className: "grid h-full place-items-center p-6 text-center text-xs text-muted-foreground",
		children: /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(FileText, { className: "mx-auto mb-2 size-6" }), "Preview not available for this file type."] })
	});
}
function DocumentsPanel({ mode, onModeChange }) {
	...
	if (mode === "minimized") return /* @__PURE__ */ jsxs("button", {
	...
	const chrome = /* @__PURE__ */ jsxs("div", {
		className: "flex items-center gap-2 border-b border-border bg-surface-2 px-3 py-2",
		children: [
			/* @__PURE__ */ jsx(Paperclip, { className: "size-4 text-primary" }),
			/* @__PURE__ */ jsx("span", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx("button", {
						...
						children: mode === "split" ? /* @__PURE__ */ jsx(PictureInPicture2, { className: "size-4" }) : /* @__PURE__ */ jsx(Columns2, { className: "size-4" })
					}),
					/* @__PURE__ */ jsx("button", {
						title: "Minimize",
	...
	const body = /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx(UploadCloud, { className: "mx-auto mb-1 size-5 text-primary" }),
					/* @__PURE__ */ jsx("div", {
			...
			children: [/* @__PURE__ */ jsxs("ul", {
				...
				children: [docs.map((d) => /* @__PURE__ */ jsxs("li", {
					...
					children: [
						/* @__PURE__ */ jsx(FileText, { className: "size-3.5 shrink-0 text-muted-foreground" }),
						/* @__PURE__ */ jsx("span", {
				...
				}, d.id)), docs.length === 0 && /* @__PURE__ */ jsx("li", {
					className: "px-3 py-3 text-[11px] text-muted-foreground",
					children: "No documents attached."
				})]
			}), /* @__PURE__ */ jsx("div", {
				className: "min-h-0",
				children: /* @__PURE__ */ jsx(Viewer, { doc: active })
			})]
		})]
	});
	if (mode === "float") return /* @__PURE__ */ jsxs("div", {
...
//#endregion
//#region src/routes/claims.new.tsx?tsr-split=component
...
function NewClaim() {
	...
	const [docMode, setDocMode] = useState("closed");
	...
	return /* @__PURE__ */ jsxs(AppShell, {
		...
		children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx(Section, {
						...
						right: /* @__PURE__ */ jsxs("span", {
							...
							children: [/* @__PURE__ */ jsx(Clock, { className: "size-3" }), " Pre-Authorization"]
						}),
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx(Field, { label: "MR / Bill no." }),
								/* @__PURE__ */ jsx(Field, { label: "Old claim no." }),
								/* @__PURE__ */ jsx(Field, { label: "Leader claim no." }),
								/* @__PURE__ */ jsx(Field, { label: "Bunch file no." })
							]
						})
					}),
					/* @__PURE__ */ jsxs(Section, {
						...
						right: /* @__PURE__ */ jsxs("button", {
							...
							children: [/* @__PURE__ */ jsx(Search, { className: "size-3" }), " Search previous claim"]
						}),
						children: [/* @__PURE__ */ jsxs("div", {
							className: "grid gap-x-6 gap-y-5 sm:grid-cols-2 lg:grid-cols-4",
							children: [
					...
					/* @__PURE__ */ jsx(Section, {
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx(Field, { label: "Outside network co-pay %" }),
								/* @__PURE__ */ jsx(Field, {
									label: "Pre natal max.",
									value: "270"
								}),
					...
					/* @__PURE__ */ jsx(Section, {
						...
						children: tab === "payment" ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsxs("table", {
								...
								}) }), /* @__PURE__ */ jsxs("tbody", { children: [lines.map((l) => /* @__PURE__ */ jsxs("tr", {
							...
							children: [/* @__PURE__ */ jsx(Plus, { className: "size-3.5" }), " Add line item"]
						})] }) : /* @__PURE__ */ jsxs("div", {
			...
			}), docMode === "split" ? /* @__PURE__ */ jsx("aside", {
				className: "xl:sticky xl:top-20 xl:h-[calc(100vh-6rem)]",
				children: /* @__PURE__ */ jsx(DocumentsPanel, {
					mode: docMode,
					onModeChange: setDocMode
				})
			}) : null]
		}), docMode !== "split" ? /* @__PURE__ */ jsx(DocumentsPanel, {
			mode: docMode,
			onModeChange: setDocMode
		}) : null]
	});
